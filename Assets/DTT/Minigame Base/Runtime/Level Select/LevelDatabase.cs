...
namespace DTT.MinigameBase.LevelSelect
{
    ...
    public class LevelDatabase : ScriptableObject
    {
        ...
        /// </summary>
        [SerializeField] private int _levelCount = 60;

        /// <summary>
        /// The amount of levels that will be unlocked if there is no save file present yet.
        /// </summary>
        [SerializeField] private int _initialUnlocks = 1;

        /// <summary>
        /// Unique ID for file saving.
        /// </summary>
        [SerializeField] private string _saveFolderName = Guid.NewGuid().ToString();
        ...
        /// The level data inside of the database.
        /// </summary>
        [SerializeField] [Tooltip("The level data inside of the database.")]
